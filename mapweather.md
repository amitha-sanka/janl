...
<script>
    ...
    function addressButtonClick(address) {
    
    alert('here');
        if (!address.trim()) {
            alert("Enter address of desired location.");
            return;
        }
       const url = 'https://google-maps-geocoding.p.rapidapi.com/geocode/json?address=Del%20Norte%2C%20San%20Diego%2C%20CA&language=en' + address ;
...
If you input an address, it will list out its latitude longitude coordinates.

<div id="addressbutton">

<br>
<label for="address">Enter the address of your desired location:</label>
<input type="text" id="address" name="address">&nbsp;&nbsp;<input type="button" value="Get Coordinate" onclick="addressButtonClick(document.getElementById('address').value)">
<br><br>